      ...
      <div className="w-[70%]">
        <div>
          <div className="flex gap-4 items-center">
            <button
              className="w-6 h-6 rounded-full text-[30px] text-medium-green"
              onClick={handlePrev}
            >
              &lt;
            </button>
            {cards.slice(currentIndex, currentIndex + 3).map((card, index) => (
              ...
              >
                <img
                  ...
                  alt="Card"
                />
                <div className="flex gap-4 font-kumbh font-normal text-light-green pb-4 justify-end">
                  <Image
                ...
                <button className="flex gap-4 justify-center font-semibold text-darker-green py-2 px-6 rounded-full border-solid border-2 border-light-green text-light-green hover:bg-[rgba(78,188,87,0.30)] hover:text-dark-green">
